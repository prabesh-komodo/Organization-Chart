...
var OrganizationChart = /** @class */ (function () {
    ...
    OrganizationChart.prototype.createNode = function (element) {
        ...
        if (element.node_type === 'transitional' && element.transition_content) {
            ...
            nodeHTML += "<div class=\"node_connector node_connector_transition-block ".concat(element.transition_content && element.transition_content.transition_logic && element.transition_content.transition_logic.length < 1 ? 'node_error' : '', "\"></div>");
        }
